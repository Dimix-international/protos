...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` //indicates wheter the user is an admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x15, 0x6d, 0x65, 0x6c, 0x6e, 0x69, 0x6b, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
